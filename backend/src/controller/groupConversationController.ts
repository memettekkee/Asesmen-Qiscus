...
import { updateParticipantRole, getParticipantById } from '../model/participantModel';
...
export const updateParticipantRoleCtrl = async (
    ...
    try {
        ...
        const updatedParticipant = await updateParticipantRole(participantId, conversationId, role);
